...
A Helm chart for Kubernetes of ocf-open-discover-service-api
...
| image.repository | string | `"ocf-open-discover-service-api"` |  |
| image.tag | string | `""` |  |
...
| volumeMounts[0].name | string | `"capif-opendiscover-service-config"` |  |
...
| volumes[0].configMap.name | string | `"capif-opendiscover-service-configmap"` |  |
| volumes[0].name | string | `"capif-opendiscover-service-config"` |  |
