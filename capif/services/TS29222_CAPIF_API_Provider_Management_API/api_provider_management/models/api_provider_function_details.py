...
from api_provider_management.models.api_provider_func_role import \
    ApiProviderFuncRole  # noqa: E501
from api_provider_management.models.base_model import Model
from api_provider_management.models.registration_information import \
    RegistrationInformation  # noqa: E501
...
class APIProviderFunctionDetails(Model):
    ...
    def api_prov_func_id(self, api_prov_func_id: str):
    ...
    @reg_info.setter
    def reg_info(self, reg_info: RegistrationInformation):
    ...
    @property
    def api_prov_func_role(self) -> ApiProviderFuncRole:
    ...
    def api_prov_func_role(self, api_prov_func_role: ApiProviderFuncRole):
    ...
    @property
    def api_prov_func_info(self) -> str:
    ...
    def api_prov_func_info(self, api_prov_func_info: str):
