...
from api_invoker_management.models.enrol_fail_reason import \
    EnrolFailReason  # noqa: E501
from api_invoker_management.models.onboarding_information import \
    OnboardingInformation  # noqa: E501
from api_invoker_management.models.websock_notif_config import \
    WebsockNotifConfig  # noqa: E501
...
class APIInvokerEnrolmentDetails(Model):
    ...
    def __init__(self, api_invoker_id=None, onboarding_information=None, notification_destination=None, request_test_notification=None, websock_notif_config=None, api_list=None, api_invoker_information=None, exp_time=None, supported_features=None, failure_reasons=None):  # noqa: E501
        ...
        :param failure_reasons: The failure_reasons of this APIInvokerEnrolmentDetails.  # noqa: E501
        :type failure_reasons: List[EnrolFailReason]
        """
        self.openapi_types = {
            'api_invoker_id': str,
            ...
            'failure_reasons': List[EnrolFailReason]
        }
    ...
    def request_test_notification(self) -> bool:
        ...
        Set to true to request the CCF to send a test notification as defined in in clause 7.6. Set to false or omitted otherwise.   # noqa: E501
    ...
    @property
    def failure_reasons(self) -> List[EnrolFailReason]:
        """Gets the failure_reasons of this APIInvokerEnrolmentDetails.


        :return: The failure_reasons of this APIInvokerEnrolmentDetails.
        :rtype: List[EnrolFailReason]
        """
        return self._failure_reasons

    @failure_reasons.setter
    def failure_reasons(self, failure_reasons: List[EnrolFailReason]):
        """Sets the failure_reasons of this APIInvokerEnrolmentDetails.


        :param failure_reasons: The failure_reasons of this APIInvokerEnrolmentDetails.
        :type failure_reasons: List[EnrolFailReason]
        """
        if failure_reasons is not None and len(failure_reasons) < 1:
            raise ValueError("Invalid value for `failure_reasons`, number of items must be greater than or equal to `1`")  # noqa: E501
