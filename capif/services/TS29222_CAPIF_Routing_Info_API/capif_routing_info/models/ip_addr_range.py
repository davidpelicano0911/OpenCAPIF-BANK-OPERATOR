...
from capif_routing_info.models.ipv4_address_range1 import \
    Ipv4AddressRange1  # noqa: E501
from capif_routing_info.models.ipv6_address_range1 import \
...
class IpAddrRange(Model):
    ...
    def __init__(self, ue_ipv4_addr_ranges=None, ue_ipv6_addr_ranges=None):  # noqa: E501
        ...
        :type ue_ipv4_addr_ranges: List[Ipv4AddressRange1]
        ...
        """
        self.openapi_types = {
            'ue_ipv4_addr_ranges': List[Ipv4AddressRange1],
    ...
    @property
    def ue_ipv4_addr_ranges(self) -> List[Ipv4AddressRange1]:
        ...
        :rtype: List[Ipv4AddressRange1]
        """
        return self._ue_ipv4_addr_ranges

    @ue_ipv4_addr_ranges.setter
    def ue_ipv4_addr_ranges(self, ue_ipv4_addr_ranges: List[Ipv4AddressRange1]):
