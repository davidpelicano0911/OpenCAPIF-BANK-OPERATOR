...
from capif_events.models.ipv4_address_range1 import \
    Ipv4AddressRange1  # noqa: E501
from capif_events.models.ipv6_address_range import \
...
class RoutingRule(Model):
    ...
    def __init__(self, ipv4_addr_ranges=None, ipv6_addr_ranges=None, aef_profile=None):  # noqa: E501
        ...
        :type ipv4_addr_ranges: List[Ipv4AddressRange1]
        ...
        """
        self.openapi_types = {
            'ipv4_addr_ranges': List[Ipv4AddressRange1],
    ...
    @property
    def ipv4_addr_ranges(self) -> List[Ipv4AddressRange1]:
    ...
    def ipv4_addr_ranges(self, ipv4_addr_ranges: List[Ipv4AddressRange1]):
    ...
    @property
    def ipv6_addr_ranges(self) -> List[Ipv6AddressRange]:
    ...
    def ipv6_addr_ranges(self, ipv6_addr_ranges: List[Ipv6AddressRange]):
    ...
    @property
    def aef_profile(self) -> AefProfile:
    ...
    @aef_profile.setter
    def aef_profile(self, aef_profile: AefProfile):
