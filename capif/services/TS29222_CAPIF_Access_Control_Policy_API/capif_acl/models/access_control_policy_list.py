...
from capif_acl.models.api_invoker_policy import ApiInvokerPolicy  # noqa: E501
...
class AccessControlPolicyList(Model):
    ...
    @property
    def api_invoker_policies(self) -> List[ApiInvokerPolicy]:
    ...
    def api_invoker_policies(self, api_invoker_policies: List[ApiInvokerPolicy]):
